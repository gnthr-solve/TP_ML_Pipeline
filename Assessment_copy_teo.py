...
def run_CorStudy_experiment(class_ratio_list, n_samples_list, n_features_list, balancing_methods, classifiers,
                            exp_title):
...
gen_dict_list = create_simple_normal_dict_list(n_samples_list[1:], n_features_list, class_ratio_list,
                                               class_distance_list)
...
print(results_df)
results_df.to_csv('alt_results_teo.csv')